...
2. **Reclassify tidal categories**: `Mangrove Forests/Salt Barrens` and `Salt Marshes` are both relabelled as `Tidal Wetlands`. All other `HMPU_TARGETS` values (`Coastal Uplands`, `Freshwater Wetlands`, `Native Uplands`) are unchanged.
