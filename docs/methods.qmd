...
This document describes the methods used to derive spatial input layers for the Tampa Bay Coastal Master Plan (TBCMP) habitat opportunity analysis. All processing is implemented in `R/funcs.R` and executed in `R/01_inputs.R`.
